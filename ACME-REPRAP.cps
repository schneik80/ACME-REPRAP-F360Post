...
function onOpen() {
  ...
  writeComment("G-code generated by Fusion 360 " + getGlobalParameter("version"));
}
...
function onExtruderTemp(temp, wait, id) {
  if (id < numberOfExtruders) {
    if (wait) {
      ...
      writeBlock(gFormat.format(10), pFormat.format(id), sOutput.format(temp), rOutput.format(100) + " ; DELETE ME");
    }
  } else {
    error(localize("This printer doesn't support the extruder ") + integerFormat.format(id) + " !");
  }
